...
lehd_od = pd.read_csv('../data/large_data/ca_od_main_JT00_2021.csv.gz', compression='gzip')
...
blocks = gpd.read_file('../data/large_data/Census_Blocks_20231127.csv').drop(columns=['geometry'])
